...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'Kitsumy-Bot', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/AtenaCovers/Atena-Bot'}, mentionedJid: [m.sender]}}}, aa);
